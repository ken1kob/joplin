...
class Setting extends BaseModel {
	...
	static metadata(): SettingItems {
		...
		this.metadata_ = {
			...
			// NOTE: A variable whose name starts with 'notes.sortOrder' is special,
			// which implies the change of the variable automatically triggers the reflesh of notes.
			// See lib/BaseApplication.ts/generalMiddleware().
