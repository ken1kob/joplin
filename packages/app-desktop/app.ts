...
const commands = [
	...
	require('./gui/MainScreen/commands/notesSortOrderSwitch'),
	require('./gui/MainScreen/commands/notesSortOrderToggleReverse'),
	...
	require('./gui/MainScreen/commands/perNotebookSortOrder'),
